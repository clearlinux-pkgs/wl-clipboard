...
Source0  : https://github.com/bugaevc/wl-clipboard/archive/v2.2.1/wl-clipboard-2.2.1.tar.gz
...
%prep
%setup -q -n wl-clipboard-2.2.1
cd %{_builddir}/wl-clipboard-2.2.1
pushd ..
cp -a wl-clipboard-2.2.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720017360
